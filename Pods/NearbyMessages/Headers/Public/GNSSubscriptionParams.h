...
@property(nonatomic) NSString *messageNamespace;
...
@property(nonatomic) GNSBeaconStrategy *beaconStrategy;
...
+ (instancetype)paramsWithMessageType:(NSString *)type __attribute__((deprecated));
...
+ (instancetype)paramsWithMessageNamespace:(NSString *)messageNamespace
                                      type:(NSString *)type
                                  strategy:(GNSStrategy *)strategy __attribute__((deprecated));

/// DEPRECATED
/// Subscription parameters using the specified strategy.
+ (instancetype)paramsWithStrategy:(GNSStrategy *)strategy __attribute__((deprecated));
